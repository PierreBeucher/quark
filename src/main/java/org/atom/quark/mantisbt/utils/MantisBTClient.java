...
public class MantisBTClient {
	...
	/**
	 * Empty constructor. Require setters to be called to configure the client.
	 */
	 ...
	 * @throws ServiceException 
	 */
	private void initRemote() throws ServiceException{
	...
	/**
	 * Set the MantisBT server URL. Calling this function
	 * will also create the java.rmi.Remote instance allowing
	 * to communicate with the server, which may result in a ServiceException
	 * being thrown.
	 * @param url url of the MantisBT server
	 * @throws ServiceException
	 */
	public void setUrl(URL url) throws ServiceException {
		this.url = url;
		initRemote();
	}
