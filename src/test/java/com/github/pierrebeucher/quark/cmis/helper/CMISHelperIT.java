 ...
 *
 */
public class CMISHelperIT extends BaseCMISHelperIT<CMISHelper>{
	...
	public static Object[] factory(String user, String password, String atomPubUrl, String wsBaseUrl) throws MalformedURLException{		
		return new Object[]{
			new CMISHelperIT(buildTestHelper(new WebServiceBindingContext(user, password, new URL(wsBaseUrl))))
		};
	}
	...
	public CMISHelperIT(CMISHelper helper) {
		super(helper);
	}
	...
	public void listDirectory() throws Exception{
		...
		for(CmisObject o : result){
			if(o.getName().equals(testFolder) && CMISUtils.isFolder(o)){
				found = (Folder) o;
				break;
			}
		}
